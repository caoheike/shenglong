...
$cjUrl = array(
	...
	'7' => array('url'=>'http://main.caipiaoapi.com:7373/hall/nodeService/api_request?uid=1626&time=1572222486&gamekey=jspk10&api=apiGameList&md5=1923d777ddf374131bb6dd266ed33899&site=api.jiekouapi.com','code'=>'jssc'), //jssc 急速赛车 
...
foreach($cjUrl as $k => $v){
	...
	*/
	$opencode = $jsondata['data'][0]['award'];
	$qihao = $jsondata['data'][0]['gid'];
	$opentime = $jsondata['data'][0]['time'];
	$next_term = $jsondata['data'][0]['nextOpenIssue'];
	$nexttime = $jsondata['data'][0]['nextOpenTime'];
	/*
	if($k == '1'){
