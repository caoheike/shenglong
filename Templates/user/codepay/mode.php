...
$codepay_config['go_time'] = 2; //3秒跳转页面 默认为首页
...
define('DB_USER', "pk10");  //数据库用户名
define('DB_PWD', "root");//数据库密码
define('DB_NAME', "pk10");  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'fn_user');  //充值用户所在数据库表名
