...
<div id="loadingPicBlock" style="max-width: 720px;margin:0 auto;" class="pay">
    ...
    <div class="g-Total gray9">请选择需要充值的金额 支付宝充值请联系游戏客服</div>
    <section class="clearfix g-member">
        <div class="g-Recharge">
            <ul id="ulOption">
                ...
                <li money="500"><a href="javascript:;">500元<s></s></a></li> <!--class="z-sel" 表示默认选中50元-->
                <li money="1000"><a href="javascript:;">1000元<s></s></a></li>
                <li money="3000"><a href="javascript:;">3000元<s></s></a></li>
                <li money="5000"><a href="javascript:;">5000元<s></s></a></li>
            </ul>
        </div>
        <form action="codepay.php" method="post">
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">手动输入金额：<label
                            class="input" style="border: 1px solid #EAEAEA;height: 35px;font-size:30px;">
                            <input type="text" name="price" id="price" placeholder="如：2000"
                    ...
                    <li paytype="3" class="gray9" type="codePay" style="width: 100%">
                        <a href="javascript:;" class="z-initsel" style="max-width: 100%;"><img style="border: 0px" src="img/weixin.jpg"><s></s></a>
