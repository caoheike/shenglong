...
/*$qr = sprintf($user_data["qrcode_url"].'?money=%s&type=%s&tag=%s&act=1',$price,$type,$pay_tag); */
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
            <div data-role="qrPayImg" class="qrcode-img-area">
                ...
                <div style="position: relative;display: inline-block;">
                    <img id='show_qrcode' alt="加载中..." src="<?php echo $qr ?>" width="260" height="340" style="display: block;">
