...
<body align="center">
    ...
    ?>
    <div class="g_w1000min open_form" style="overflow: auto;">
        <div class="sub_right  ">
            <div class="sub_r_bot">
...
<?php }elseif ($game == 'bjl') {
                    ...
                    <tbody id="reslist" linNos="0,1,2,5">
                        ...
                        foreach ($cons as $con) {
                            ...
                            ?> </td>
                                ...
                                <td class="gray"><?php if(in_array('BankerWin', $result)){
                                    echo '◇';
                                }
                            ?></td>
                                <td class="blue"><?php if(in_array('PlayerWin', $result)){
                                    echo '◇';
                                }
                            ?></td>
    ...
    ?>
					<thead>
						<tr id="th_header">
							<th width="120" class="">时间</th>
							<th width="80" class="">期数</th>
							<th width="500" class="">开奖号码</th>                          	
							<th colspan="3" class="" width="50">总和</th>
                          <th width="30" class="">龙虎</th>
