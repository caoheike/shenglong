	...
	<tbody>
		<tr>
			<td style="wdith:100%">
				...
				<button id="butSend" style="background: #00bfff; width: 120px; height: 70px; font-size: 28px; margin: 0 10px;border:0px;">发 送</button>
			</td>
		</tr>
	</tbody>
</table>
...
if($kefu != ""){
    ?>
<div align="center">
	<div class="bubble bubbleS2" style="font-size:30px;"><font style="font-size:35px;">公告</font><br><?php echo $kefu;
    ?></div>
</div>
<?php }
?>
