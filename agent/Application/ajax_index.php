...
$m += (int) get_query_val('fn_bjlorder', 'sum(`money`)', "`roomid` = '{$_SESSION['agent_room']}' and `jia` = 'false' and `addtime` like '" . date('Y-m-d') . "%' and (`status` > 0 or `status` < 0)");
...
$z += (int) get_query_val('fn_bjlorder', 'sum(`status`)', "`roomid` = '{$_SESSION['agent_room']}' and `jia` = 'false' and `addtime` like '" . date('Y-m-d') . "%' and status >= 0");
...
$arr['allprice'] += (int) get_query_val('fn_bjlorder', 'sum(`money`)', "`roomid` = '{$_SESSION['agent_room']}' and `jia` = 'false' and (`status` > 0 or `status` < 0) and `addtime` like '" . date('Y-m-d') . "%'");
