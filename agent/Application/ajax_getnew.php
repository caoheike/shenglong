...
$newfinance = (int)get_query_val('fn_finance', 'count(*)', "roomid = '{$_SESSION['agent_room']}' and status =0");
$newpay = 0;
$sfdata = array();
...
echo json_encode(array("newsf" => $newsf, 'newxf' => $newxf, 'newpay' => $newpay, 'sfdata' => $sfdata, 'xfdata' => $xfdata, 'newmsg' => $newmsg, 'newfinance' => $newfinance));
exit;
?>