...
echo mb_substr($console, 0, 1, 'utf-8');
?></b><?php 
echo mb_substr($console, 1, 1, 'utf-8');
?></span>
...
?> -
                        <?php 
echo get_query_val("fn_room", "version", array("roomid" => $_SESSION['agent_room']));
?>
                          <small>到期时间: <?php 
echo get_query_val("fn_room", "roomtime", array("roomid" => $_SESSION['agent_room']));
?></small>
                    </p>
                  </li>
                  <!-- Menu Body -->
...
?>"><a href="index.php?m=g_setting&g=bjl"><i class="fa fa-circle-o"></i>百家乐</a></li>
                <li class="<?php 
if ($_GET['g'] == "pk10") {
	echo 'active';
}
...
?>"><a href="index.php?m=g_setting&g=azxy5"><i class="fa fa-circle-o"></i>澳洲幸运5</a></li> 
...
?>">
				<a href="index.php?m=res_open">
					<i class="fa fa-gear"></i><span>预设开奖</span>
				</a>
			</li>
            <li class="<?php 
if ($_GET['m'] == "user") {
...
?>"><a href="index.php?m=finance"><i class="fa fa-money"></i><span>财务管理</span><span class="label pull-right bg-red fade finance-msg ">3</span></a></li>
            <li class="<?php 
if ($_GET['m'] == 'termcount') {
	echo 'active';
}
...
?>"><a href="index.php?m=addterm"><i class="fa fa-cubes"></i> <span>手动补期</span></a></li>-->
            <li class="header">About</li>
            <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>葫芦科技智投系统</span></a></li>
            <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Version 3.0.1</span></a></li>
...
if ($_GET['m'] == '') {
	...
	require 'templates/finance.html';
} else {
...
?>
        ...
        <footer class="main-footer">
          ...
          <!-- Default to the left -->
          <strong>Copyright &copy; 2018 <a href="#">89ye源码版权所有</a>.</strong> All rights reserved.
        </footer>
