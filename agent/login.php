  ...
  <div class="login-box-body">
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
        <input id="user" name="user" type="text" class="form-control" placeholder="账号" value="<?php 
if ($_COOKIE['agentuser'] != "") {
	echo $_COOKIE['agentuser'];
}
?>">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input id="pass" name="pass" type="password" class="form-control" placeholder="密码" value="<?php 
if ($_COOKIE['agentpass'] != "") {
	echo $_COOKIE['agentpass'];
}
?>">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input id="room" name="room" type="number" class="form-control" placeholder="房间号" value="<?php 
if ($_COOKIE['agentroom'] != "") {
	echo $_COOKIE['agentroom'];
}
?>">
    ...
    <div class="social-auth-links text-center">
      ...
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-tachometer"></i> 本程序版权 www.89ye.com 89ye源码</a>
    </div>
  </div>
  <!-- /.login-box-body -->
</div>
