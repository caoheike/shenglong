...
<html style="font-size: 126px;"><head>
    ...
    ?>
        <script src="ft/cocos2d_gd.js"></script>
    <?
        }else{
    ?>
...
<script src="ft/platform/jsloader.js" id="result"></script>
<script src="ft/platform/cocos1.js"></script>
<script src="ft/platform/cocos2.js"></script>
<script src="ft/platform/cocos3.js"></script>
<script src="ft/resource.js"></script>
<script src="ft/total.js"></script>
<script src="ft/platform/main.js"></script>
</body>
</html>