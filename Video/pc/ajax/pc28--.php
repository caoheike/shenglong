...
if(count($codes) != 20){
	...
	if($gametype == "pc28a"){
		...
		$number1 = (int)$codes[2] + (int)$codes[3] + (int)$codes[8] + (int)$codes[11] + (int)$codes[14] + (int)$codes[17];
		$number2 = (int)$codes[3] + (int)$codes[6] + (int)$codes[9] + (int)$codes[12] + (int)$codes[15] + (int)$codes[18];
		$number3 = (int)$codes[4] + (int)$codes[7] + (int)$codes[10] + (int)$codes[13] + (int)$codes[16] + (int)$codes[19];
