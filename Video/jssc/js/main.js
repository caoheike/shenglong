function activateflame(e, a) {
    parseInt($("#car" + a).css("left")) > e ? ($(".car" + a + " .wind").css("display", "block"),
    $(".car" + a + " .flame").css("display", "block")) : ($(".car" + a + " .wind").css("display", "none"),
    $(".car" + a + " .flame").css("display", "none"))
}
function animate() {
    ...
    var L = document.getElementById("car1")
      , C = document.getElementById("car2")
      , N = document.getElementById("car3")
      , S = document.getElementById("car4")
      , q = document.getElementById("car5")
      , _ = document.getElementById("car6")
      , D = document.getElementById("car7")
      , F = document.getElementById("car8")
      , O = document.getElementById("car9")
...
function startcountdown(e, a) {
    if (TweenLite.killDelayedCallsTo(winnerpage),
    ...
    countdowninv = setInterval(function() {
        countdowntimer(e -= 1),
        countdown(e),
        0 == e && (clearInterval(countdowninv),
        clearInterval(countdowninv2),
        setTimeout(pubmethod.doAjax(a.issue, a.lotCode, a.type, !1), "2000"))
    }, 1e3);
    var t = 99;
...
function countdowntimer(e) {
    ...
    e <= 2 && $(".redlight").css("display", "block"),
    2 == e && videoTools.ifsund() && ($("#sound").attr("src", "sound/cuttime.mp3"),
    $("#sound").removeAttr("loop"),
    document.getElementById("sound").play()),
    e <= 1 && $(".yellowlight").css("display", "block"),
    0 == e && (startanimation(),
...
function startanimation() {
    setTimeout(function() {
        videoTools.ifsund() && ($("#sound").attr("src", "sound/staring.mp3"),
...
function finishgame(e) {
    if (setTimeout(function() {
        ...
        videoTools.ifsund() && ($("#sound").removeAttr("loop"),
        document.getElementById("sound").play()),
        setTimeout(function() {
    ...
    for (var r = e.split(","), s = 0; s < 10; s++) {
        ...
        l /= 10;
        var i = parseInt(r[s]) - 1
          , c = 100 * s - carpositionoffset[i] + 350
          , d = c + "px"
          , f = "car" + r[s]
...
function resultpage(e) {
    ...
    for (var a = e.split(","), t = 0; t < 10; t++) {
        var n = parseInt(a[t]) - 1
          , o = 100 * t - carpositionoffset[n] + 350 + "px"
          , r = "car" + a[t];
        $("#" + r).css("left", o)
    }
    showcurrentresult(e),
...
$(function() {
    $(".currentdraw").on("click", "#closeSound", function() {
        $(this).hasClass("closesoundbtn") ? ($(this).removeClass("closesoundbtn"),
        document.getElementById("sound").play(),
        ifopen = !0) : ($(this).addClass("closesoundbtn"),
        ifopen = !1,
        void 0 != $("#sound").attr("src") && document.getElementById("sound").pause())
    })
});
var carpositionoffset = [0, 9, 25, 40, 53, 67, 78, 101, 122, 139], countdowninv, countdowninv2, animation3 = setInterval(function() {
    windflameani()
}, 150);
