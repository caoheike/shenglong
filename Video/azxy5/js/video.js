...
pubmethod.tools = {
    type: function(e) {
        for (var t = [["cqnc", "10009"], ["xgc", "10048", "10051"], ["egxy", "10046"], ["gxklsf", "10038"], ["jisuft", "10035", "10057", "10058"], ["twbg", "10047"], ["fcsd", "10041", "10043"], ["bjkl8", "10013", "10014", "10054"], ["klsf", "10005", "10011", "10034", "10053"], ["pk10", "10001", "10012", "10037"], ["qgc", "10039", "10040", "10042", "10044", "10045"], ["ssc", "10002", "10003", "10004", "10010", "10036", "10050", "10059", "10060", "10064", "10065", "10066"], ["kuai3", "10007", "10026", "10027", "10028", "10029", "10030", "10031", "10032", "10033", "10052", "10061", "10062", "10063"], ["shiyi5", "10006", "10008", "10015", "10016", "10017", "10018", "10019", "10020", "10021", "10022", "10023", "10024", "10025", "10055"]], o = 0, r = t.length; o < r; o++)
...
pubmethod.creatHeadD = {
    pk10: function(e, t) {
        ...
        if ("100002" == o.result.businessCode)
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            t.flag)
                $("#hlogo").find("img").attr("src", "img/logo-10010.png"),
                $(".statuslogo").css({
                    background: "url(img/logo/logo-10010.png)no-repeat"
                }),
                startcountdown(r, t);
            else {
                if (!t.flag && r <= 1)
    ...
    ssc: function(e, t) {
        ...
        if (0 == a.errorCode && 0 == a.result.businessCode) {
            for (var o = (a = a.result.data).lotCode, r = pubmethod.tools.cutTime(a.drawTime, a.serverTime), s = a.preDrawCode.split(","), i = [], u = 0, n = s.length; u < n; u++)
    ...
    shiyi5: function(e, t) {
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            console.log(i),
            t.flag)
                $(".nameLogo").find("img").attr("src", "img/logo/11x5_" + t.lotCode + ".png"),
                k3v.startVideo(o, t),
    ...
    klsf: function(e, t) {
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            if (t.flag)
                $(".video_box").css("background", "url(img/logo/" + t.lotCode + ".jpg) 0 0 no-repeat"),
    ...
    kuai3: function(e, t) {
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            if (t.flag)
                $(".nameLogo").find("img").attr("src", "img/logo/" + t.lotCode + ".png"),
                k3v.stopVideo(l, t);
            else {
                if (!t.flag && r <= 1)
                    throw new Error("error");
    ...
    fcsd: function(e, t) {
        ...
        if (0 == o.errorCode && 0 == o.result.businessCode) {
            ...
            o.preDrawCode = i,
            t.flag)
                $(".logo").css("background", "url(img/logo/" + t.lotCode + ".png) center center no-repeat"),
                fcsdv.startVid(o, t);
            else {
                if (t.flag && r <= 1)
                    throw new Error("error");
