function sscAnimateEnd(o, e) {
    lotCodestr = lotCode,
    animate.sscAnimateEnd(o.preDrawCode, o.id, o.counttime, !1, e),
...
$(function() {
    ...
    $(".menubox").on("click", ".tyrbtn", function() {
        $(this).attr("id") || ($(this).attr("id", "true"),
    ...
    $(".menubox").on("click", ".soundbtn", function() {
        if ($(this).hasClass("closesoundbtn")) {
            ...
            $("audio");
            $(".oping ").is(":hidden") ? videoTools.ifsund() && ($("#bgsound").attr("src", "sound/bg.mp3"),
            videoTools.sounds.soundsT.play("bgsound")) : videoTools.ifsund() && ($("#bgsound").attr("src", "sound/opening.mp3"),
...
animate.sscAnimate = function(o) {
    ...
    videoTools.ifsund() && ($("#bgsound").attr("src", "sound/opening.mp3"),
    videoTools.sounds.soundsT.play("bgsound"));
    var e = setInterval(function() {
        for (var e = $(o).find(".box"), n = $(e).find("span").length, s = 0; s < n; s++) {
            "10060" == lotCodestr ? ($(e).find("span").css("color", "transparent"),
            $(e).find("span").eq(s).removeClass().addClass("cznum" + $(e).find("span").eq(s).text())) : $(e).find("span").eq(s).removeClass().addClass("num" + $(e).find("span").eq(s).text()),
...
animate.sscAnimateEnd = function(o, e, n, s, t) {
    videoTools.ifsund() && ($("#bgsound").attr("src", "sound/over.mp3"),
    videoTools.sounds.soundsT.play("bgsound")),
...
videoTools.xz3D = function(o, e) {
    var o = $(o);
    e ? ($(o).children(".flip").eq(0).addClass("out").removeClass("in"),
    setTimeout(function() {
        $(o).find(".flip").show().eq(1).addClass("in").removeClass("out"),
        $(o).children(".flip").eq(0).hide()
    }, 225)) : ($(o).children(".flip").eq(1).addClass("out").removeClass("in"),
    setTimeout(function() {
...
videoTools.showNUM = function(o, e) {
    ...
    setTimeout(function() {
        videoTools.ifsund() && ($("#bgsound").attr("src", "sound/bg.mp3"),
        setTimeout(videoTools.sounds.soundsT.play("bgsound"), 1e3))
    }, 2800),
    $(".tl").find(".box").each(function(o) {
        var n = ""
          , s = $(this).find("span").eq(1).attr("class");
        e[o] >= 5 ? (n = "bigbg",
        -1 != s.indexOf(n) || (s = s.replace("smallbg", n))) : (n = "smallbg",
        -1 != s.indexOf(n) || (s = s.replace("bigbg", n))),
    ...
    $(".bl").find(".box").each(function(o) {
        var n = ""
          , s = $(this).find("span").eq(1).attr("class");
        e[o] % 2 == 0 ? (n = "doublebg",
        -1 != s.indexOf(n) || (s = s.replace("singlebg", n))) : (n = "singlebg",
        -1 != s.indexOf(n) || (s = s.replace("doublebg", n))),
        $(this).find("span").eq(1).removeAttr("class").attr("class", s)
    })
}
,
videoTools.sounds = {
    soundsT: {
        play: function(o) {
            videoTools.ifsund() && ("sound/over.mp3" == $("#" + o).attr("src") ? $("#" + o).removeAttr("loop", "loop") : $("#" + o).attr("loop", "loop"),
...
videoTools.testOpen = function() {
    var o = 0
      , e = setInterval(function() {
        ++o >= 8 && (clearInterval(e),
        animate.sscAnimateEnd(videoTools.createNum(), "#numBig", datestr, !0),
        setTimeout(function() {
            setTimeout(function() {
